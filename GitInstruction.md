...
При работе в двух ветках одновременно может возникнуть ситуация, когда в одной и другой ветке по-разному изменили блок текста. Потому что мы эхх...
...
## 13. Удаление веток
***git branch -d branch имя ветки*** - команда позволяетттт удалить ветку, которую слили с основной.

***git branch -D имя ветки*** - команда позволяет принудительно ууууудалить ветку.